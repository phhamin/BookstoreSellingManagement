<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="PublisherDetail.aspx.cs" Inherits="BookstoreSellingManagement.PublisherDetail" %>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Publisher Detail</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                                    ...
                                    <div class="row">                                      
                                        <div class="col-lg-12">      
                                            <asp:UpdatePanel ID="panel" runat="server">
                                                <ContentTemplate>
                                                    <div class="mb-3">
                                                        <label for="publisher-name-input" class="form-label">Publisher Name</label>
                                                        <asp:TextBox ID="txtPublisherName" class="form-control" runat="server" placeholder="Enter Publisher Name" ></asp:TextBox>
                                                        <i runat="server" class="input-notify" id="iValidPublisherName" visible="false" >Please enter Publisher Name!</i>
                                                    </div>    
                                                    <div class="mb-3">
                    ...
                    <div class="position-fixed bottom-0 end-0 p-3"  style="z-index: 11">
                        <div id="liveToastCreate" class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="1000" data-bs-autohide="true" runat="server">
                            ...
                            <div class="toast-body text-success">
                                Publisher has been created successfully.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="position-fixed bottom-0 end-0 p-3"  style="z-index: 11">
                        <div id="liveToastUpdate" class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="1000" data-bs-autohide="true" runat="server">
                            ...
                            <div class="toast-body text-success">
                                Publisher has been updated successfully.
                            </div>
                        </div>
                    </div>
                </div>
